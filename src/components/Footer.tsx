      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-4 font-light text-sm">
                <li><a href="#discover" className="hover:text-brand-red transition-colors">Butiker</a></li>
                <li><a href="#discover" className="hover:text-brand-red transition-colors">Mat & Dryck</a></li>
                <li><a href="#discover" className="hover:text-brand-red transition-colors">Kaféer</a></li>
                <li><a href="#discover" className="hover:text-brand-red transition-colors">Kultur</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-4 font-extralight text-sm">
                <li><a href="#about" className="hover:text-brand-red transition-colors">Om oss</a></li>
                <li><a href="#events" className="hover:text-brand-red transition-colors">Evenemang</a></li>
                <li><a href="mailto:info@nytorgsstraket.se" className="hover:text-brand-red transition-colors">Kontakt</a></li>
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] uppercase tracking-widest text-white/20 font-medium font-din">
            &copy; {year} Nytorgsstråket. Alla rättigheter förbehållna.
          </p>
