...
export const FALLBACK_EVENTS_DATA: EventData[] = [
  ...
  {
    id: 14,
    slug: generateSlug('Daricci Ceramic Workshop'),
    date: '03 Maj',
    end_date: '2026-05-03',
    tag: 'Kultur',
  ...
  {
    id: 15,
    slug: generateSlug('Mineral TV: Trail Community Film Night'),
    date: '06 Maj',
    end_date: '2026-05-06',
    tag: 'Kultur',
  ...
  {
    id: 16,
    slug: generateSlug('Lykke Live: Monkeys With Internet'),
    date: '07 Maj',
    end_date: '2026-05-07',
    tag: 'Musik',
  ...
  {
    id: 17,
    slug: generateSlug('Lykke Live: Samira Manners & Frida Green'),
    date: '21 Maj',
    end_date: '2026-05-21',
    tag: 'Musik',
  ...
  {
    id: 18,
    slug: generateSlug('Lykke Live: Elin Wiigh'),
    date: '28 Maj',
    end_date: '2026-05-28',
    tag: 'Musik',
  ...
  {
    id: 19,
    slug: generateSlug('Lykke Live: Tintenfish'),
    date: '29 Maj',
    end_date: '2026-05-29',
    tag: 'Musik',
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        const sortEvents = (evs: EventData[]) => {
          return [...evs].sort((a, b) => {
            if (a.id === 1) return -1;
            if (b.id === 1) return 1;
